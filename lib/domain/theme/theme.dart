...
class AppTheme {
  ...
  // static const green = Color.fromARGB(255, 31, 188, 83);
  // static const redOscuro = Color.fromARGB(255, 205, 55, 53);
  // static const green = Color.fromARGB(255, 33, 145, 76);
  // static const red = Color.fromARGB(255, 212, 63, 63);
  // static const yellow = Color.fromARGB(255, 245, 183, 13);
  // static const purple = Color.fromARGB(255, 144, 13, 245);
}
